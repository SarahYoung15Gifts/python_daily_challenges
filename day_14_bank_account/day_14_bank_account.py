...
class BankAccount:
	...
	def withdraw(self, amount):
		if amount > self.balance:
			return f"{self.owner} attempted to withdraw ${amount}, but insufficient funds. Current balance: ${self.balance}"
		else:
			self.balance -= amount
